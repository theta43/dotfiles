...
/* appearance */
static const char font[]            = "-*-dejavu sans-*-r-*-*-10-*-*-*-*-*-*-*";
 ...
 * 7F00FF Purple
 */
static const char selbordercolor[]  = "#D64E12";
static const char selbgcolor[]      = "#D64E12";
...
/* tagging */
static const char *tags[] = { "Code", "Media", "Term", "Web" };
